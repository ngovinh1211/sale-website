        ...
        <div id="content">
            ...
            <div class="container-fluid black-color">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="color_id">Color Title</label>
                                <input type="text" name="color" id="color_id" class="form-control" placeholder="Enter color" required>
                                <p><?= $data['error'] ?></p>
                            </div>
                            <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header bg-info">
                        <h3>Color List</h3>
                        <button class="btn btn-success open-modal-btn">Add Color</button>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered black-color">
                            ...
                            <tbody>
                                ...
                                foreach ($data['color'] as $index => $color) {
                                    ...
                                    <td><a href="'.$data['url'].'/admin/editColor/' . $color['color_name'] . '" class="btn btn-warning">Edit</a></td>
                                    <td><button class="btn btn-danger" onclick="deleteColor(' . $color['id'] . ')">Delete</button></td>
                                </tr>';
                                };
...
<script>
    ...
    deleteColor = (id) => {
        var deleteConfirm = confirm('Are you sure to delete this color?');
        if (deleteConfirm) {
            deleteForm.action = url + '/admin/deleteColor/' + id;
            deleteForm.submit();
        }
    }
</script>