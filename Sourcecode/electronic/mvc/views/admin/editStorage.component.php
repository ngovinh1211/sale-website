                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="storage" value="<?= $data['storage']['storage_name'] ?>" id="storage_id" class="form-control" placeholder="Enter storage" required>
                                <p><?= $data['error'] ?></p>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success">Update</button>
                                <a href="<?=$data['url']?>/admin/storage" class="btn btn-warning">Cancel</a>
                            </div>
                    </div>
                    </form>
                </div>
