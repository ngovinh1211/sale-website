                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="color" value="<?= $data['color']['color_name'] ?>" id="color_id" class="form-control" placeholder="Enter color" required>
                                <p><?= $data['error'] ?></p>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-success">Update</button>
                                <a href="<?=$data['url']?>/admin/color" class="btn btn-warning">Cancel</a>
                            </div>
                    </div>
                    </form>
                </div>
