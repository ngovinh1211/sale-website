                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if ($data['deletedProduct'] == null) {
                            ...
                            <a href="'.$url.'/admin/product">See All Product</a>
                        </div>';
                        } else {
                            ...
                            foreach ($data['deletedProduct'] as $index => $product) {
                                $product['thumbnail'] = str_replace("./public", "$url/public", $product['thumbnail']);
                                echo '<tr>
                                    <td>' . (++$index) . '</td>
...
<script>
    ...
    restoreProduct = (id) => {
        ...
        if (restoreConfirm) {
            form.action = url + '/admin/restoreProduct/' + id;
            form.submit();
        }
    }
    ...
    deleteProduct = (id) => {
        ...
        if (deleteConfirm) {
            form.action = url + '/admin/destroyProduct/' + id;
            form.submit();
        }
    }
</script>