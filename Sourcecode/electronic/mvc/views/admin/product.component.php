            ...
            <div class="container-fluid black-color">
                <div class="card">
                    <div class="card-header bg-info">
                        <h3>Product List</h3>
                        <a href="<?=$data['url']?>/admin/createProduct" class="btn btn-success">Create Product</a>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered black-color">
                            ...
                            <tbody>
                                ...
                                foreach ($data['product'] as $index => $product) {
                                    echo '<tr>
                                    <td>' . (++$index) . '</td>
                                    <td><img src="' . str_replace("./public", "$url/public", $product['thumbnail']) . '" style="width: 80px;" alt=""></td>
                                    <td>' . $product['title'] . '</td>
                                    <td>$' . $product['price'] . '</td>
                                    <td>' . $product['category_name'] . '</td>
                                    <td>' . $product['brand_name'] . '</td>
                                    <td>' . $product['updated_at'] . '</td>
                                    <td><a href="'.$url.'/admin/productDetail/' . $product['id'] . '" class="btn btn-warning">Detail</a></td>
...
<script>
    ...
    deleteProduct = (id) => {
        ...
        if (deleteConfirm) {
            deleteForm.action = url + '/admin/deleteProduct/' + id;
            deleteForm.submit();
        }
    }
</script>