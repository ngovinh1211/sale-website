                            ...
                            <tbody>
                                ...
                                foreach ($data['account'] as $index => $account) {
                                    echo '<tr>
                                            ...
                                            <td><a href="'.$url.'/admin/editAccount/' . $account['id'] . '" class="btn btn-warning">Edit</a></td>';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?=$data['$url']?>/admin/login">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    deleteAccount = (id) => {
        ...
        if (deleteConfirm) {
            deleteForm.action = url + '/admin/deleteAccount/' + id;
            deleteForm.submit();
        }
    }
</script>