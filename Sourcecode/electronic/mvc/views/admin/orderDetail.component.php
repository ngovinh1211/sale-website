                        ...
                        <table class="table table-bordered black-color">
                            ...
                            <tbody>
                                ...
                                foreach ($data['orderDetail'] as $index => $orderDetail) {
                                    echo '<tr>
                                                <td>' . (++$index) . '</td>
                                                <td><img src="' . str_replace("./public", "$url/public", $orderDetail['thumbnail']) . '" style="width: 80px;" alt=""></td>
                                                <td>' . $orderDetail['title'] . '</td>
                                                <td>' . $orderDetail['category_name'] . '</td>
                                                <td>' . $orderDetail['brand_name'] . '</td>
                                                <td>' . $orderDetail['storage_id'] . '</td>
                                                <td>' . $orderDetail['color_id'] . '</td>
                            ...
                            <tr>
                                <th colspan="8" style="text-align: center;">Order Price</th>
                                <th colspan="7" style="text-align: center;">$<?= $totalPrice ?></th>
                            </tr>
                        </table>
                    </div>
                </div>
